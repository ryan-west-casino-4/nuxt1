  ...
  >
    <div class="fixed top-0 right-0 px-6 py-4 sm:block">
      <NuxtLink v-if="authStore.user" to="/dashboard">
        <a class="ml-4 text-sm text-gray-700 underline"> Dashboard </a>
      </NuxtLink>

      <template v-else>
        <NuxtLink to="/login">
          <a class="text-sm text-gray-700 underline">Login</a>
        </NuxtLink>

        <NuxtLink to="/register">
          <a class="ml-4 text-sm text-gray-700 underline"> Register </a>
        </NuxtLink>
      </template>
    </div>
